      ...
      <div className='mx-auto grid max-w-[1440px] grid-cols-1 gap-10 px-4 md:grid-cols-12 md:gap-6'>
        <div className='md:col-span-4 flex flex-col gap-8'>
          ...
          <div className='flex items-center gap-4'>
            <img src='./src/assets/Vector.svg' alt='' width={42} height={42} />
            <img
        ...
        <div className='md:col-span-2 flex items-start justify-end gap-4'>
          <img
            src='./src/assets/Group 427319388.svg'
            alt='Instagram'
            width={48}
            height={48}
          />
          <img
            src='./src/assets/Group 427319389.svg'
            alt='Facebook'
            width={48}
            height={48}
          />
          <img
            src='./src/assets/Group 427319390.svg'
            alt='Twitter'
            width={48}
            height={48}
          />
