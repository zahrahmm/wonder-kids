      ...
      <h1 className='h1 font-semibold max-w-[937px] mx-auto'>
        ...
        <span className='relative h2 font-normal font-courgette text-yellow-300'>
          ...
          <img
            ...
            src='./src/assets/Line element 2.svg'
          ></img>
        </span>{' '}
        <br /> for kids
      </h1>
